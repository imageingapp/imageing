...
export default function SettingScreen() {
	...
	const onMultiUpload = () => {
		// Alert
		setDialog(true);
		setDialogTitle(`${multiUpload === 'Enabled' ? 'Disable' : 'Enable'} Multi-Upload`);
		setDialogDescription(`Do you want to ${multiUpload === 'Enabled' ? 'disable' : 'enable'} the multi-upload feature?`);
	...
	const onZoomAndDrag = () => {
		// Alert
		setDialog(true);
		setDialogTitle(`${zoomAndDrag === 'Enabled' ? 'Disable' : 'Enable'} Image Zoom and Drag`);
		setDialogDescription(`Do you want to ${zoomAndDrag === 'Enabled' ? 'disable' : 'enable'} the image zoom and drag feature?`);
	...
	const settingsOptions = [
		...
		{ title: 'Multi-Upload', subTitle: multiUpload, onPress: onMultiUpload }, // Modal which asks for Enabled/Disabled
		{ title: 'Image Zoom and Drag', subTitle: zoomAndDrag, onPress: onZoomAndDrag }, // Modal which asks for Enabled/Disabled
